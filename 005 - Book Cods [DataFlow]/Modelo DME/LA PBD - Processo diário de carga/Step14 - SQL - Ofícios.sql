...
-- eLaw: union das 3 bases + join + filtro Ofícios em um único fluxo
elaw_oficios AS (
  SELECT DISTINCT
...
Final AS (
  SELECT DISTINCT
    ...
    DATA_DE_REGISTRADO_TRATADA AS DATA_REGISTRADO,
    ...
    EMPRESA_CODE,
    LEGALES_REITERATORIO,
    COALESCE(DATA_DE_REGISTRADO_MAX_TAREFA, DATA_DE_REGISTRADO_TRATADA) AS DATA_REGISTRADO_COMPOSTA,
    COALESCE(DATA_DE_CONFIRMACAO_MAX_TAREFA, DATA_DE_ENCERRAMENTO_TRATADA) AS DATA_ENCERRAMENTO_COMPOSTA,
    DATE_DIFF(
      COALESCE(DATA_DE_CONFIRMACAO_MAX_TAREFA, DATA_DE_ENCERRAMENTO_TRATADA),
      COALESCE(DATA_DE_REGISTRADO_MAX_TAREFA, DATA_DE_REGISTRADO_TRATADA),
      DAY
