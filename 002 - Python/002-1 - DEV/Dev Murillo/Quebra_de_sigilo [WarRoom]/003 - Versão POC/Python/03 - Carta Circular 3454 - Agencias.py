"""
================================================================================
03 - CARTA CIRCULAR 3454 - AGÊNCIAS
================================================================================
Descrição: Gera arquivos de agências para Carta Circular 3454
Objetivo: Exportar dados de agências em formato TXT (separado por tabulação)
Conexão: SBOX_LEGALES (BigQuery e Storage)
Saída: AGENCIAS.txt (geral) e {IDENTIFICACAO}_AGENCIAS.txt (por investigado)
================================================================================
"""
...
# OBTER DADOS
# ============================================================================
print('Obtendo dados de agências...')
table_name = "meli-bi-data.SBOX_LEGALES.TBL_QS_AGENCIAS_FINCH"
command = """SELECT 
...
# ============================================================================
print('Salvando arquivo geral AGENCIAS.txt...')
...
print('Processo de geração de agências concluído.')
