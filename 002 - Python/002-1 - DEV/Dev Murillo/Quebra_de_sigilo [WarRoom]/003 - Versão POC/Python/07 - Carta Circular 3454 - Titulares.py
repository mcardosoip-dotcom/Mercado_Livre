"""
================================================================================
07 - CARTA CIRCULAR 3454 - TITULARES
================================================================================
Descrição: Gera arquivos de titulares para Carta Circular 3454
Objetivo: Exportar dados de titulares com endereços validados
Conexão: SBOX_LEGALES (BigQuery e Storage)
Saída: {IDENTIFICACAO}_TITULARES.txt (por investigado)
================================================================================
"""
...
# ============================================================================
# OBTER DADOS (com endereços validados)
# ============================================================================
print('Obtendo dados de titulares com endereços validados...')
table_name = "meli-bi-data.SBOX_LEGALES.TBL_QS_TITULARES_COM_ENDERECOS_VALIDADOS_FINCH"
command = """SELECT 
    IDENTIFICACAO,
    NUMERO_BANCO,
    NUMERO_AGENCIA,
...
for id in ids:
    ...
    if len(filtered_data) > 0:
        ...
        id_filename = id_directory + id_sanitized + "_TITULARES.txt"
...
print('Processo de geração de titulares concluído.')
