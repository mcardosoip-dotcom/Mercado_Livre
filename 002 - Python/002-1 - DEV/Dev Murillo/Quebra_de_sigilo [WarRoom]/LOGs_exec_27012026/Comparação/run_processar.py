...
if re.search(pattern, html_content, re.DOTALL):
    ...
    print("⚠️ Padrão não encontrado. Verificando estrutura...")
    if 'Comparação Real dos Dados' in html_content:
