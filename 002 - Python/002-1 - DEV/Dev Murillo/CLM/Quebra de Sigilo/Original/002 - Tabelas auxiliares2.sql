...
CREATE
OR REPLACE TABLE SBOX_LEGALES.STG_QS_RELACIONADO_CAD_VF AS (
    SELECT
...
CASE
    ...
    FROM
        SBOX_LEGALES.STG_QS_AUX_PAYOUT_REL_CAD_VF
    UNION
    DISTINCT
    SELECT
        DISTINCT ID_PAGAMENTO,
...
CASE
        ...
        END AS NOME_REL
    FROM
        SBOX_LEGALES.STG_QS_PAGAMENTO_REL_CAD_VF
    UNION
    DISTINCT
    SELECT
        DISTINCT ID_PAGAMENTO,
...
CASE
        ...
        END AS NOME_PESSOA_REL
    FROM
        SBOX_LEGALES.STG_QS_WITHDRAWAL_REL_CAD_VF
    UNION
    DISTINCT
    SELECT
        DISTINCT ID_PAGAMENTO,
...
CASE
        ...
        END AS NOME_PESSOA_REL
    FROM
        SBOX_LEGALES.STG_QS_AUX_PAYIN_REL_CAD_VF
);

-- CRIAR TABELA DE FLAG_MOV
CREATE
OR REPLACE TABLE SBOX_LEGALES.STG_QS_FLAG_MOV_CAD_VF AS (
    SELECT
        TIT.CUS_CUST_ID,
CASE
    ...
    FROM
        ...
        LEFT JOIN SBOX_LEGALES.STG_QS_AUX_MOVIMENTACAO2_CAD_VF MOV ON TIT.CUS_CUST_ID = MOV.CUS_CUST_ID
);