MERGE SBOX_LEGALES.CAD_TBL_QS_EXTRATO_NAO_CORRESPONDENTE A USING SBOX_LEGALES.STG_QS_NAO_CORRESPONDENTE_CAD_VF B ON A.DATAHORA_IMPORTACAO = B.DATAHORA_IMPORTACAO
WHEN MATCHED THEN DELETE;

INSERT INTO
    SBOX_LEGALES.CAD_TBL_QS_EXTRATO_NAO_CORRESPONDENTE
SELECT
    '<area>' AS VERTICAL,
    IDENTIFICACAO,
    DOC_NUMBER,
...
MERGE SBOX_LEGALES.CAD_TBL_QS_EXTRATO_MOVIMENTACAO A USING SBOX_LEGALES.STG_QS_TITULAR_CAD_VF B ON A.DATAHORA_IMPORTACAO = B.DATAHORA_IMPORTACAO
WHEN MATCHED THEN DELETE;

INSERT INTO
    SBOX_LEGALES.CAD_TBL_QS_EXTRATO_MOVIMENTACAO
SELECT
