...
account_file = destination_execution_file + "EXTRATO.txt"
...
table_name = "ddme000426-gopr4nla6zo-furyid.STG.TBL_QS_EXTRATO_TUNING"
source_import_table = "ddme000426-gopr4nla6zo-furyid.STG.STG_QS_PLANILHA_PRESENTA_CAD_VF_TUNING"
dim_date_table = "ddme000426-gopr4nla6zo-furyid.STG.DIM_DATE_TUNING" # Assuming this also needs tuning suffix
...
;""".format(table_name, dim_date_table, source_import_table)
...
for id_val in ids:
    ...
    filtered_data.dropna(how='all', subset=["CODIGO_CHAVE_EXTRATO", "NUMERO_BANCO", "NUMERO_AGENCIA", "NUMERO_CONTA", "TIPO_CONTA", "DATA_LANCAMENTO", "NUMERO_DOCUMENTO",
                                            "DESCRICAO_LANCAMENTO", "TIPO_LANCAMENTO", "VALOR_LANCAMENTO", "NATUREZA_LANCAMENTO", "VALOR_SALDO", "NATUREZA_SALDO", "LOCAL_TRANSACAO"], inplace=True)
