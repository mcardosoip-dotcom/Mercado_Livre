...
root_folder = f"LEGALES/{area}/QUEBRA_SIGILO/"
...
table_name = "ddme000426-gopr4nla6zo-furyid.STG.TBL_QS_CONTAS_TUNING"
source_import_table = "ddme000426-gopr4nla6zo-furyid.STG.STG_QS_PLANILHA_PRESENTA_CAD_VF_TUNING" 

command = """SELECT TRIM(IDENTIFICACAO) as IDENTIFICACAO, NUMERO_BANCO, NUMERO_AGENCIA, NUMERO_CONTA, TIPO_CONTA, DATA_ABERTURA_CONTA, DATA_ENCERRAMENTO_CONTA, MOVIMENTACAO_CONTA 
FROM `{}` 
