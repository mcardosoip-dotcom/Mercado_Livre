...
Objetivo:
    ...
    Todos os arquivos consolidados são salvos na pasta Embargos.
"""
...
# Pasta raiz do script: Onde o arquivo Python está localizado (para salvar os arquivos Excel e parquet)
PASTA_RAIZ_SCRIPT = os.path.dirname(os.path.abspath(__file__))

# Pasta de destino: Onde serão salvos os arquivos consolidados (mesma pasta do script)
PASTA_DESTINO = PASTA_RAIZ_SCRIPT
...
def main():
    ...
    # ============================================
    # ETAPA 2: Consolidar todos os arquivos e remover duplicatas por processo_id
    # ============================================
    print("\n" + "=" * 70)
    print("ETAPA 2: CONSOLIDAÇÃO FINAL E REMOÇÃO DE DUPLICATAS")
    print("=" * 70)
    ...
    # ============================================
    # ETAPA 3: Criar arquivo de mapeamento
    # ============================================
    print("\n" + "=" * 70)
    print("ETAPA 3: CRIAÇÃO DO ARQUIVO DE MAPEAMENTO")
    print("=" * 70)
    ...
    # ============================================
    # ETAPA 4: Criar análise de colunas
    # ============================================
    print("\n" + "=" * 70)
    print("ETAPA 4: CRIAÇÃO DA ANÁLISE DE COLUNAS")
    print("=" * 70)
    ...
    print(f"[INFO] Para gerar o arquivo Excel com filtros, execute: Gerar_Excel_Filtro.py")
