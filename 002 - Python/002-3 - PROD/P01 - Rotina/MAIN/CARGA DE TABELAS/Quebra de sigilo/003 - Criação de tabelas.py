...
CAMINHO_PARQUETS = r"G:\Drives compartilhados\Legales_Analytics\001 - Base\001-03 - Quebra de Sigilo"

# Caminho onde o arquivo .txt será salvo
CAMINHO_SAIDA = r"G:\Drives compartilhados\Legales_Analytics\002 - Python\002-3 - PROD\P01 - Rotina\MAIN\CARGA DE TABELAS\Quebra de sigilo\comandos_create_tables.txt"
