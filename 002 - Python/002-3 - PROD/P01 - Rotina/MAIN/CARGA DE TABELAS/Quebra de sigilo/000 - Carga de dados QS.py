...
caminho_scripts = r"G:\Drives compartilhados\Legales_Analytics\002 - Python\002-3 - PROD\P01 - Rotina\MAIN\CARGA DE TABELAS\Quebra de sigilo"

# Lista dos scripts a serem executados, na ordem
scripts = [
    "001 - Criação de parquet.py",
