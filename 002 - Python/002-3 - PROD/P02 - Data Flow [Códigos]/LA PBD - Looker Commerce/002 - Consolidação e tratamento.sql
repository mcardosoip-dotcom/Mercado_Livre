CREATE
OR REPLACE TABLE `<ENV>.STG.COMMERCE_DATABASE_FULL` AS WITH unified_data AS (
    SELECT
        Responsavel,
        Solicitante,
        Data_de_solicitacao,
    ...
    FROM
        `<ENV>.STG.COMMERCE_DATABASE_2021`
    UNION
    ALL
    SELECT
        Responsavel,
    ...
    FROM
        `<ENV>.STG.COMMERCE_DATABASE_2022`
    UNION
    ALL
    SELECT
        Responsavel,
    ...
    FROM
        `<ENV>.STG.COMMERCE_DATABASE_2023`
    UNION
    ALL
    SELECT
        Responsavel,
    ...
    FROM
        `<ENV>.STG.COMMERCE_DATABASE_2024`
    UNION
    ALL
    SELECT
        Responsavel,
    ...
    FROM
        `<ENV>.STG.COMMERCE_DATABASE_2025`
)
SELECT
    *
FROM
