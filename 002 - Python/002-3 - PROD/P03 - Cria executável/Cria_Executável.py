# ============================================================
# GERADOR DE EXECUTÁVEL - LA PROCESSOS
# ============================================================
# Descrição: Script para gerar executável do LA Processos
...
def criar_executavel():
    ...
    # Comando PyInstaller
    # Usando --windowed para aplicação GUI (sem console)
    # Se quiser ver logs de debug, pode trocar por --console
    comando = [
        "pyinstaller",
        "--onefile",                    # Cria um único arquivo executável
        "--windowed",                   # Aplicação GUI (sem console)
        ...
        "--hidden-import", "tkinter",   # Garante que tkinter seja incluído
        "--hidden-import", "tkinter.ttk",  # Garante que ttk seja incluído
        "--hidden-import", "tkinter.scrolledtext",  # Garante que scrolledtext seja incluído
    ...
    try:
        ...
        if executavel_criado.exists():
            ...
            print(f"💡 Todos os arquivos foram salvos em: {caminho_destino}")
            return True
        else:
...
def limpar_arquivos_temporarios():
    ...
    for pasta in pastas_limpar:
        pasta_path = diretorio_atual / pasta
    ...
    for arquivo in arquivos_limpar:
        arquivo_path = diretorio_atual / arquivo
...
def main():
    """Função principal."""
    print("\n" + "="*60)
    print("GERADOR DE EXECUTÁVEL - LA PROCESSOS")
    print("="*60)
