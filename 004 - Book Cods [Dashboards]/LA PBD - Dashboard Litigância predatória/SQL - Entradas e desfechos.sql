...
FROM
  `ddme000426-gopr4nla6zo-furyid.STG.LK_PBD_LA_ENTRADAS_E_DESFECHOS` AS a
  LEFT JOIN `ddme000426-gopr4nla6zo-furyid.STG.LK_PBD_LA_ADVOGADOS_DEEP_LEGAL_FATO` AS b ON CAST(a.processo_id AS STRING) = CAST(b.processo_id AS STRING)
WHERE
  Advogado_Deep_Legal IS NOT NULL