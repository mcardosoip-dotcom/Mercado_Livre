CREATE OR REPLACE TABLE `ddme000426-gopr4nla6zo-furyid.STG.LK_PBD_LA_BUDGET_REAL_FINAL` AS
...
FROM
    Base_Real base
LEFT JOIN `ddme000426-gopr4nla6zo-furyid.STG.LK_PBD_LA_BUDGET_DICIONARIO_FATO` AS dic
