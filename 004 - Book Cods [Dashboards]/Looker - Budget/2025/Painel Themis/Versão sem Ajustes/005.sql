...
FROM
    `pdme000426-c1s7scatwm0-furyid.STG.LK_PBD_LA_BUDGET_LOOKER_INPUT` AS A
    LEFT JOIN `pdme000426-c1s7scatwm0-furyid.STG.LK_PBD_LA_BUDGET_DICIONARIO_VENDOR_FATO` AS B ON a.Vendor_Desc = b.Vendor_Desc