...
function exportarRelatoriosCrucePorEmail() {
  ...
  // 2. ALTERAÇÃO: Label para Cruce 7
  const LABEL_MAP = {
  ...
  try {
    ...
    if (sheetsCopied > 0) {
      ...
      // --- 2. LIMPAR CRUCE 4 DA ABA RESUMO ---
      ...
      // 3. ALTERAÇÃO: Adicionado CRUCE_7 na ordem
      const ordemExibicao = [
        "CRUCE_1_VALOR_MAIOR_QUE_RETIDO",
        "CRUCE_2_ERRO_ID_DEUDA",
        "CRUCE_3_ENLIGHTEN_NAO_EXECUTOU",
